    ...
    <div style={s.seccion}>
      ...
      <form onSubmit={handleGuardar} style={s.formParametros}>
        ...
        <div style={{ display: "flex", gap: "0.75rem", marginTop: "1rem" }}>
          <button type="submit" className="btn-primary" disabled={guardando || !hayambios}
...
function TabBloques() {
  ...
  const handleFormChange = (e) => {
    ...
    setForm((prev) => {
      ...
      /* Al cambiar tipo, recalcular hora_fin sugerida si hay hora_inicio */
      if (name === "tipo" && prev.Bloque_Horario_Hora_Inicio) {
        const dur = duracionSugerida(value);
        next.Bloque_Horario_Hora_Fin = sumarMinutos(prev.Bloque_Horario_Hora_Inicio, dur);
      }
      /* Al cambiar hora_inicio, derivar jornada automáticamente */
    ...
    <div style={s.seccion}>
      <div style={{ ...s.seccionHeader, flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          ...
          <p style={s.seccionDesc}>
            Registra los bloques de tiempo disponibles en la jornada escolar (CU49).
          </p>
        </div>
          ...
          <div style={s.panel}>
            ...
            <div style={s.panelBody}>
              <form onSubmit={handleGuardar}>
                  ...
                  {TIPOS_BLOQUE.map((t) => {
                    ...
                    return (
                      <button key={t} type="button"
                        onClick={() => handleFormChange({ target: { name: "tipo", value: t } })}
                        style={{
                ...
                {/* Jornada (derivada automáticamente, editable si es necesario) */}
    ...
    <div style={s.seccion}>
      <div style={{ ...s.seccionHeader, flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          ...
          <p style={s.seccionDesc}>
            Registra eventos que afectan el normal desarrollo de clases.
          </p>
        </div>
        <div style={{ display: "flex", gap: "0.5rem", alignItems: "center", flexShrink: 0 }}>
          <div style={{ display: "flex", border: "1px solid #e5e7eb", borderRadius: 8, overflow: "hidden" }}>
            ...
            <div style={s.panelBody}>
              ...
              <form onSubmit={handleGuardar}>
                ...
                <input type="text"
                  ...
                  style={s.inputPanel}
                  placeholder="Ej: Licenciatura 4tos Medios" required />
...
const s = {
  ...
  /* Panel lateral */
  backdrop: {
    position: "fixed", inset: 0, background: "rgba(0,0,0,0.18)", zIndex: 980,
  },
  panel: {
